                        ...
                        <div className="position-sticky pt-3">
                            <ul className="nav flex-column">
                                <li className="nav-item">
                                    <button className="nav-link add-todo-btn" onClick={() => setShowFormModal(true)}>
                                ...
                                <li className="nav-item">
                                    <button className="nav-link search-todo-btn" onClick={() => setShowSearchModal(true)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                             viewBox="0 0 24 24">
                                            <path fill="currentColor" fillRule="evenodd"
                                ...
                                <li className="nav-item">
                                    <Link to="/app/today"
                                          className={`nav-link ${path === "/app/today" ? "active" : ""}`}>
                                ...
                                <li className="nav-item">
                                    <Link to="/app/upcoming"
                                          className={`nav-link ${path === "/app/upcoming" ? "active" : ""}`}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                             viewBox="0 0 24 24">
                                            <path fill="currentColor" fillRule="evenodd"
                                ...
                                <li className="nav-item">
                                    <Link to="/app/completed"
                                          className={`nav-link ${path === "/app/completed" ? "active" : ""}`}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                             viewBox="0 0 24 24">
                                            <path fill="currentColor" fillRule="evenodd"
                                ...
                                <li className="nav-item">
                                    <Link to="/app/expired"
                                          className={`nav-link ${path === "/app/expired" ? "active" : ""}`}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                             viewBox="0 0 24 24">
                                            <path fill="currentColor" fillRule="evenodd"
